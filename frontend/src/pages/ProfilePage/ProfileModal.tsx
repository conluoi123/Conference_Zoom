...
import { NotificationsSettings } from '../../components/pages/common/NotificationsSettings_tmp';
import { PrivacySettings } from '../../components/pages/common/PrivacySettings';
