                    ...
                    {showWelcome && (
                      ...
                      >
                        <div className="flex justify-between items-start mb-4">
                          <h3 className="text-lg font-medium">Cuộc họp đã sẵn sàng</h3>
                          <button onClick={() => setShowWelcome(false)}><X size={20}/></button>
                        </div>
                        <p className="text-sm text-gray-600 mb-4">Chia sẻ đường liên kết này với những người bạn muốn tham gia</p>
                        
                        <div className="flex items-center justify-between bg-gray-100 p-3 rounded-lg border">
                          <span className="text-xs truncate mr-2">{window.location.href}</span>
                          <button onClick={handleCopy} className="text-blue-600"><Copy size={18}/></button>
                        </div>
                      </motion.div>
                    )}
              </AnimatePresence>
