              ...
              <div className="grid grid-cols-7 gap-2 text-center">
                ...
                {Array.from({ length: daysInMonth }).map((_, i) => {
                  ...
                  return (
                    <button
                      key={day}
                      className={`cursor-pointer h-9 rounded-lg text-sm font-medium relative transition-colors ${
                        isSelected
                      ...
                      onClick={() => {
                        ...
                        const key = getLocalDateKey(newDate);
                        const meetings = schedulesByDate[key] || [];
